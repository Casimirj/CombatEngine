from .gear_slot import GearSlot
...
# On first access the underlying ``app.GameDefinitions.Potions`` package is
...
def _ensure_potions_registered():
    ...
    if not _POTIONS_LOADED:
        import app.GameDefinitions.Potions  # noqa: F401
...
def _ensure_prayers_registered():
    ...
    if not _PRAYERS_LOADED:
        import app.GameDefinitions.Prayers  # noqa: F401
