...
class TestWeaponAttack(unittest.TestCase):
    ...
    def test_hit_when_attack_roll_exceeds_def_roll(self):
        with patch("CombatSim.CombatEngine.Domain.Rng.Rng.random", return_value=0.1):
    ...
    def test_miss_when_random_above_hit_chance(self):
        with patch("CombatSim.CombatEngine.Domain.Rng.Rng.random", return_value=0.99):
    ...
    def test_miss_when_attack_roll_below_def_roll(self):
        with patch("CombatSim.CombatEngine.Domain.Rng.Rng.random", return_value=0.5):
